...
TIME_LINE_DIR = os.path.abspath(os.path.join(BASE_DIR, "..", "..", "Time_line"))
if os.path.isdir(TIME_LINE_DIR) and TIME_LINE_DIR not in sys.path:
    sys.path.insert(0, TIME_LINE_DIR)
